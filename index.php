...
<header class="container">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-item nav-link lang" href="#home" key="menu_inicio">Inicio</a>
        
        <a class="nav-item nav-link lang" href="#ejesTematicos" key="menu_informacion">Información</a>
        <a class="nav-item nav-link lang" href="#comoParticipar" key="menu_comoParticipar">¿Cómo puedo participar?</a>
        <a class="nav-item nav-link lang" href="#program" key="menu_programa">Programa</a>
        <a class="nav-item nav-link lang" href="#registrationForm" key="menu_registro">Preregistro</a>
      ...
      <div class="col-12 col-sm-8 infoTemas">
        ...
        <div class="row contenidoCongreso">
          <figure class="col">
            ...
            <figcaption class="lang" key="que_encontrar_1">Conferencias<br>Magistrales</figcaption>
          </figure>
          <figure class="col">
            <img src="images/home/CEMEL_Mesas.png" alt="Mesas de reflexión" class="img-fluid">
            <figcaption class="lang" key="que_encontrar_2">Mesas de<br>Reflexión</figcaption>
          </figure>
          <figure class="col">
            <img src="images/home/mesasE.png" alt="Feria cultural">
            <figcaption class="lang" key="que_encontrar_3">Mesas con<br>expertos</figcaption>
          </figure>
          <figure class="col">
            <img src="images/home/CEMEL_Talleres.png" alt="Talleres y Ponencias" class="img-fluid">
            <figcaption class="lang" key="que_encontrar_4">Talleres /<br>Ponencias</figcaption>
          </figure>
          <figure class="col">
            <img src="images/home/CEMEL_FeriaCultural.png" alt="Feria cultural">
            <figcaption class="lang" key="que_encontrar_5">Feria<br>Cultural</figcaption>
          </figure>
          <figure class="col">
            <img src="images/home/analisis.png" alt="Feria cultural">
            <figcaption class="lang" key="que_encontrar_6">Análisis y reflexión entre expertos</figcaption>
          </figure>
...
<section class="container-fluid" id="informacionImportante">
  <div class="row">
    ...
    <div class="col-12 col-sm-5 infoFechas">
      <p class="titulo lang" key="fechas_importantes_titulo">Fechas<br>importantes</p>
      <div class="row">
        
        <div class="col-6 col-sm-6">
          <p class="info lang" key="fechas_importantes_1">Lanzamiento<br>de la convocatoria</p>
        </div>
        <div class="col-6 col-sm-6">
          <p class="numeroFecha lang"  key="fechas_importantes_fecha_1">1 <span class="fecha">marzo 2018</span></p>
        </div>
